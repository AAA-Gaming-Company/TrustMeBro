...
public class ItemOnGround : MonoBehaviour {
    ...
    public void Setup(WeaponType weapon, MMF_Player pickupFeedback) {
        this.weapon = weapon;
        this.pickupFeedback = pickupFeedback;
    ...
    private void OnTriggerEnter2D(Collider2D other) {
        if (other.gameObject.CompareTag("Player")) {
            ...
            player.inventory.AddItem(this.weapon);

            if (this.pickupFeedback != null) {
                this.pickupFeedback.PlayFeedbacks();
            }
